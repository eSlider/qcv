...
{   
    ...
    class CSeqDevHDImg: public CSeqDeviceControl<TInpImgFromFileVector>
    {
        Q_OBJECT
    ...
    /// Register outputs
    public:
        virtual bool registerOutputs ( TInpImgFromFileVector & f_input_v );
    ...
    private:
        ...
        TInpImgFromFileVector         m_imageData_v;
